...
public class JsonDataSource(IDataCoreProvider dataCoreProvider) : IDataSource
{
    ...
    {
        //ToDo File-Handling
        File.WriteAllText(dataCoreProvider.ActiveCore.Id + "_" + ".json", dataCoreProvider.ActiveCore.Serialize());
    }
    ...
    public void Load()
    {
        ...
        foreach (var file in files)
        {
            try
            {
                ...
                var valueDataCore = JsonSerializer.Deserialize<ValueDataCore>(jsonPayload);
