...
public partial class DataCoreProvider : IDataCoreProvider
{
    ...
    public IDataCore GetOrCreateDataCore(ValueDataCore valueDataCore)
    {
        var dataCore = GetOrCreateDataCore(valueDataCore.Id);

        foreach (var valueModule in valueDataCore.ModuleValues)
        {
